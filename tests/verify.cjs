...
assert.equal(cards, 14, "Selected build count changed; update the portfolio metric and test intentionally");
assert.ok(html.includes('<strong>14</strong><span>SELECTED BUILDS</span>'), "Hero build metric matches the cards");
